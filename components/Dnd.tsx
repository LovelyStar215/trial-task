    ...
    return (
        <DndContext onDragEnd={onDragEnd}>
            <div className="flex justify-center items-center mb-3">
                <Button onClick={saveLayout}>{isLockedLayout ? <svg fill="#494c4e" version="1.1" id="Capa_1" width="22px" height="26px" viewBox="0 0 574.922 574.922">
                    <g><g><path d="M491.102,238.031v-33.892c0-27.472-5.39-54.146-16.021-79.278c-10.26-24.255-24.937-46.028-43.624-64.717
                        ...
                        <path d="M485.289,574.922H89.632c-32.334,0-58.64-26.306-58.64-58.641v-220.4c0-14.615,5.431-28.626,15.292-39.451
                                ...
                                c-88.39,0-160.3,71.91-160.3,160.299V237.241z"/></g>
                        <g><path d="M287.461,302.375c-34.337,0-62.272,27.936-62.272,62.273c0,26.639,16.816,49.422,40.388,58.299v40.58v8.488
                            ...
                            <path d="M286.997,493.938c-6.562,0-12.724-2.904-16.907-7.969c-3.233-3.914-5.013-8.869-5.013-13.953v-48.724
                                ...
                                S297.901,345.715,287.461,345.715z"/></g></g>
                        ...
                        <>
                            ...
                            <Dialog>
                                ...
                                <DialogContent className="sm:max-w-[425px]">
                                    ...
                                    <DialogFooter>
                                        <DialogClose asChild>
                                            <Button className="bg-black text-white" onClick={handleSaveDashboard}>Create Dashboard</Button>
                                        </DialogClose>
                                    </DialogFooter>
                                </DialogContent>
                            </Dialog>
                                                    ...
                                                    val.components?.map((component, index) => {
                                                        return (
                                                            <Draggable key={component.id} draggableId={component.id.toString()} index={index}>
                                                                {
                                                                    (provided) => (
                                                                        <div className="bg-gray-200 mx-1 my-1 rounded-md h-64 text-black border-2 border-pink-500 relative"
                                                                        ...
                                                                        >
                                                                            <div className="flex justify-end items-center right-0 absolute bg-pink-500 rounded-bl-md">
                                                                                            ...
                                                                                            <svg fill="#ffffff" version="1.1" id="Capa_1" width="12px" height="12px" viewBox="0 0 494.936 494.936">
                                                                                                <g><g><path d="M389.844,182.85c-6.743,0-12.21,5.467-12.21,12.21v222.968c0,23.562-19.174,42.735-42.736,42.735H67.157
                                                                                                    ...
                                                                                                    <path d="M483.876,20.791c-14.72-14.72-38.669-14.714-53.377,0L221.352,229.944c-0.28,0.28-3.434,3.559-4.251,5.396l-28.963,65.069
                                                                                                        ...
                                                                                                        c2.518,2.51,3.905,5.855,3.905,9.414C470.516,51.036,469.127,54.38,466.61,56.897z"/></g></g>
                                                                                            </svg>
                                                                                        </Button>
                                                                                    </DialogTrigger>
                                                                                    <DialogContent className="sm:max-w-[425px]">
                                                                                        ...
                                                                                        <DialogFooter>
                                                                                            <DialogClose asChild>
                                                                                                <Button onClick={editDashboard} className="text-white bg-black">Save Dashboard</Button>
                                                                                            </DialogClose>
                                                                                        </DialogFooter>
                                                                                    </DialogContent>
                                                                                </Dialog>
                                                                                <Dialog>
                                                                                    <DialogTrigger asChild>
                                                                                        <Button onClick={() => setIdToFilter(component.id)}>
                                                                                            <svg fill="#ffffff" height="10px" width="10px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 31.112 31.112">
                                                                                    ...
                                                                                    <DialogContent className="sm:max-w-[425px]">
                                                                                        ...
                                                                                        <DialogFooter>
                                                                                            ...
                                                                                            <Button onClick={handleFilter} variant="outline" className="text-white bg-black">OK</Button>
                                                                                        </DialogFooter>
                                                                                    </DialogContent>
                                                                                </Dialog>
                                                                            </div>
