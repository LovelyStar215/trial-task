...
const Header = () => {
    ...
    const metamaskButton = (
        <div className="flex justify-center items-center px-3 mb-0 border-2 border-solid border-pink-400 rounded-xl cursor-pointer">
            ...
            <nav className="h-full flex justify-between container items-center w-full">
                <div className="flex items-center">
                    ...
                    </Link>
                    {
                        user && (
                            connected ? (
                                <span className="text-white"><span className="font-bold">Address: </span>{walletAddress}</span>
                            ) : metamaskButton
                        )
                    }
                </div>
                    ...
                    {user && (
                        <>
                            <li className="cursor-pointer">
                                <Link href="/bonus" className="text-ct-dark-600">
                                    <span className="link link-underline link-underline-black pb-2 px-2 text-white"> Bonus Points </span>
                                </Link>
                            </li>
